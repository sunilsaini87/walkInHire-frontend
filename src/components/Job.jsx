  ...
  return (
    <div className="p-5 rounded-md shadow-xl bg-white border border-gray-100">
      ...
      <div className="flex items-center gap-2 mt-4">
        ...
        <Badge className={"text-[#100603] font-bold"} variant={"ghost"}>
          {job?.jobType}
        </Badge>
        <Badge className={"text-[#200b2e] font-bold"} variant={"ghost"}>
          {job?.salary}LPA
        </Badge>
      </div>
      <div className="flex items-center gap-4 mt-4">
        ...
        <Button className="bg-[#204a84] rounded-lg">Save For Later</Button>
      </div>
      <div>
